"""Compatibility shim for the LangGraph explainibility pipeline."""
...
from explainibility_agents.config import ExplainabilityConfig as OrchestratorConfig
from explainibility_agents.pipeline import run_explainibility_pipeline

Holding = None  # Backwards compatibility placeholder


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the SmartFolio explainibility orchestrator")
